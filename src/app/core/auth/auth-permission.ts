export function getModule(route: string) {
    if (route.includes('role') || route.includes('settings') || route.includes('user') || route.includes('categories') || route.includes('category') || route.includes('countries')
        || route.includes('country') || route.includes('campaign') || route.includes('subscription-model') || route.includes('address-type') || route.includes('invoice-type') || route.includes('vat-type') || route.includes('payment-type') || route.includes('pricing-model') || route.includes('case-type') || route.includes('case-cagetory')) {
        return 'Settings';
